...
function getBadgeSvg(badgeInfo: any) {

    const color1 = _.isString(badgeInfo.color1) ? badgeInfo.color1 : colors[badgeInfo.color1].rgb, color2 = _.isString(badgeInfo.color2) ? badgeInfo.color2 : colors[badgeInfo.color2].rgb, color3 = _.isString(badgeInfo.color3) ? badgeInfo.color3 : colors[badgeInfo.color3].rgb;
