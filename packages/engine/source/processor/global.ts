...
export default () => {
    ...
    return driver.getInterRoom().then((data) => {
        ...
        const bulkObjects = driver.bulkObjectsWrite(), bulkRooms = driver.bulkRoomsWrite(), bulkUsers = driver.bulkUsersWrite(), bulkTransactions = driver.bulkTransactionsWrite(), bulkUsersMoney = driver.bulkUsersMoney(), bulkUsersResources = driver.bulkUsersResources(), bulkUsersPowerCreeps = driver.bulkUsersPowerCreeps(), bulkMarketOrders = driver.bulkMarketOrders(), bulkMarketIntershardOrders = driver.bulkMarketIntershardOrders(), activateRooms = {}, usersById = _.indexBy(users, '_id'), roomObjectsByType = _.groupBy(roomObjects, 'type');
