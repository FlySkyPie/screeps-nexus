...
export default (object: any, intent: any, { roomObjects, roomController, gameTime, eventLog }: any) => {
    ...
    const healPower = utils.calcBodyEffectiveness(object.body, BodyParts.HEAL, 'heal', ScreepsConstants.HEAL_POWER);
    ...
    eventLog.push({
        ...
        data: {
            targetId: target._id,
            amount: healPower,
            healType: ScreepsConstants.EVENT_HEAL_TYPE_MELEE
        }
    });
};
