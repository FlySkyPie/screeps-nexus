...
export function make(_runtimeData, _intents, _register, _globals) {
     ...
     * @constructor
     */
    const Structure = register.wrapFn(function(id) {
        if(id) {
            this.id = id;
            const _data = data(id);
    ...
    const OwnedStructure = register.wrapFn(function(id) {
     ...
     * @constructor
     */
    const StructureContainer = register.wrapFn(function (id) {
        Structure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureController = register.wrapFn(function (id) {
     ...
     * @constructor
     */
    const StructureExtension = register.wrapFn(function (id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureExtractor = register.wrapFn(function (id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureKeeperLair = register.wrapFn(function (id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureLab = register.wrapFn(function (id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureLink = register.wrapFn(function (id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureObserver = register.wrapFn(function (id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructurePowerBank = register.wrapFn(function (id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructurePowerSpawn = register.wrapFn(function (id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureRampart = register.wrapFn(function (id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureRoad = register.wrapFn(function(id) {
        Structure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureStorage = register.wrapFn(function(id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureTerminal = register.wrapFn(function (id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureTower = register.wrapFn(function (id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureWall = register.wrapFn(function (id) {
        Structure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureSpawn = register.wrapFn(function (id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructureNuker = register.wrapFn(function (id) {
        OwnedStructure.call(this, id);
    });
     ...
     * @constructor
     */
    const StructurePortal = register.wrapFn(function (id) {
        Structure.call(this, id);
    });
